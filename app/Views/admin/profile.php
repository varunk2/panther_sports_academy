          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <h3 class="profile-username text-center">Vishesh Dahiya</h3>

                <p class="text-muted text-center">A Cool guy</p>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <p class="text-muted">Sonepat, Haryana</p>
                ...
                <p class="text-muted">
                  <span class="tag tag-danger">Football</span>
                  <span class="tag tag-success">Body Fitness</span>
                  <span class="tag tag-info">Sportsmen</span>
                </p>
            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  <li class="nav-item"><a class="nav-link active" href="#activity" data-toggle="tab">Contact Queries</a></li>
